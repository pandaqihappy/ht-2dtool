/*
 * @Author: your name
 * @Date: 2020-04-26 15:19:13
 * @LastEditTime: 2020-05-13 10:33:07
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \htTool\src\core\plugin\CreateEdgeInteractor.js
 */
require('../../../lib/core/ht')
import { uuid } from '../util/index'
var CreateEdgeInteractor = function (graphView, cb) {
...
ht.Default.def(CreateEdgeInteractor, ht.graph.Interactor, {
    ...
    handleWindowTouchEnd: function (e) {
        ...
        if(this._targetNode){
            ...
            let param = { id, sourceId, targetId }
            if (cb) cb(param)
        }
